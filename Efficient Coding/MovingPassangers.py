###Q-> There are N people in city, who wants to visit Kingdom of Dreams. 
###The road of reaching of Kingdom is not so safe. 
###Therefore, they go to kingdom only in a security vehicle, which can accommodate at the most two people 
...
###If two people travel in vehicle, the cost of travel will be the maximum of cost of two people. 
###Calculate the minimum total cost so that all N people can reach Kingdom safely.
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def solve(n, cost):
